...
class MainWindow(ctk.CTk):
    def __init__(self, global_config):
        ...
        self.test_button = ctk.CTkButton(self.button_frame, text="Test TTS", text_color="#d1d1d1", font=("Consolas", 14, "bold"), width=220, border_width=1, border_color="#888888")
        ...
        self.ignore_list_label.grid(row=5, column=0, sticky="nw")
        ...
        self.update_ignore_list_button = ctk.CTkButton(self.main_frame, text="Update Ignore List", font=("Consolas", 14, "bold"), command=self.update_ignore_list, width=220, border_width=1, border_color="#888888")
        self.update_ignore_list_button.grid(row=6, column=0, columnspan=2, sticky="ne", pady=(2, 15), padx=(0, 3))

        # Save Config button
        self.save_config_button = ctk.CTkButton(self.main_frame, text="Save Config", font=("Consolas", 14, "bold"), command=self.save_config, width=220, border_width=1, border_color="#888888")
        self.save_config_button.grid(row=6, column=0, columnspan=1, sticky="nw", pady=(2, 15), padx=(3, 0))
